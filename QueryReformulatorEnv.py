...
class QueryReofrmulatorEnv():
    ...
    def step(self, actions):
        ...
        if (len(expanded_queries) == 0):  # or self.counsteps > 10):
            done = True
        return [text, expanded_queries], reward, done, {}
    ...
    def train_samples(self,sample_num):
        ...
        [text, expanded_queries], reward, done, found = self.step(actions)
        #print "text = ", text
